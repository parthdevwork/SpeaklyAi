...
//   // Define audio paths for iOS and Android
...
//   console.log('*******recordedAudio**********', questionAnswers);
...
//   useEffect(() => {
//     const extractedQuestions = extractContentData
//       .split('\n')
//       .filter(q => q.trim() !== '');
...
//       Tts.speak(questions[currentQuestionIndex], {});
//     } else {
//       setIsSpeaking(false);
//       setIsRecording(true);
//     }
...
//     try {
//       if (recordedAudio !== '') {
//         const ans = recordedAudio;
//         const que = currentQuestion;
//         if (ans && que) {
//           const {data, error} = await supabase
//             .from('que_ans')
//             .insert([{ans, que, part: part, email: isLoginData.email}]);
//           if (error) {
//             console.error('Error adding question and answer:', error.message);
//           }
//         }
...
//             {
//               role: 'user',
//               content: 'Generate IELTS speaking questions for Part 1.',
//             },
//           ],
//           stream: true,
//           max_tokens: 596,
...
//           .request(config)
//           .then(response => {
//             setExtractContentData(extractContent(response.data));
//             setLoader(false);
//           })
//           .catch(error => {
...
//             {
//               role: 'user',
//               content: 'Generate IELTS speaking questions for Part 2.',
//             },
//           ],
//           stream: true,
//           max_tokens: 596,
...
//       {
//         role: 'user',
//         content: 'Generate IELTS speaking questions for Part 3.',
//       },
//     ],
//     stream: true,
//     max_tokens: 596,
...
//             <FastImage
//               source={require('../../../assets/svg/Soundwave.gif')}
//               style={{
...
//           <Button title="stop" /> */}
//           <TouchableOpacity
//             // disabled={isRecording === false ? true : false}
...
//           <Text style={styles.modalTxt}>Wait for a moment.....</Text>
//         </View>
//       </Modal>
//     </>
//   );
